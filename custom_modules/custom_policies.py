...
class CustomPolicy_2x32(FeedForwardPolicy):
    def __init__(self, *args, **kwargs):
        super(CustomPolicy_2x32, self).__init__(*args, **kwargs,
...
class CustomPolicy_3_var(FeedForwardPolicy):
    def __init__(self, *args, **kwargs):
        super(CustomPolicy_3_var, self).__init__(*args, **kwargs,
                                           net_arch=[dict(pi=[70, 46, 30],
                                                          vf=[70, 26, 10])],
                                           feature_extraction="mlp")

# Register the policy, it will check that the name is not already taken
register_policy('CustomPolicy_2x32', CustomPolicy_2x32)
