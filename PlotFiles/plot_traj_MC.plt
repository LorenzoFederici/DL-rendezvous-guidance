...
filename4 = indir.'Trajectory_MC.txt'
...
plot for [k=0:Nsim-1] filename4 i k every 10 using 2:1 w l lt 12 notitle
replot filename1 using 2:1 w l lt 11 notitle "$\\pi^{unp}$"
...
"\\usepackage{amsmath}\n\\usepackage{siunitx}"
set output 'traj_MC_gnuplot.tex'
replot